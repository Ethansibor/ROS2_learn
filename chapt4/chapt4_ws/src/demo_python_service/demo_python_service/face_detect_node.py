...
class FaceDetectorionNode(Node):
    def __init__(self):
        ...
        self.set_parameters([rclpy.Parameter('face_locations_model',rclpy.Parameter.Type.STRING,'cnn')])#改变自身节点的参数
        self.add_on_set_parameters_callback(self._parameter_callback)#当参数被更新时，ROS2就会自动调用这个回调函数，并传入更新的参数数组
